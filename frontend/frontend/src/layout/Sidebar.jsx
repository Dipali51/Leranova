  ...
  <ul className="ml-8 space-y-5 text-black-500">
    ...
    <li>Ratings & reviews</li>
        ...
        <li className="flex items-center gap-3 px-3 py-2">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 10.5A1.5 1.5 0 106 9a1.5 1.5 0 001.5 1.5zm4.5 0A1.5 1.5 0 1011 9a1.5 1.5 0 001.5 1.5zm4.5 0A1.5 1.5 0 1015.5 9a1.5 1.5 0 001.5 1.5z" />
          </svg>
          Community
        </li>
    ...
    <li>Enquiries</li>
        ...
        {/* More */}
        <li className="flex items-center gap-3 px-3 py-2 text-gray-500">
          More
